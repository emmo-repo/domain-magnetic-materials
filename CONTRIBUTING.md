...
The task `pixi run start-new-release-branch <version_string>` facilitates the start of the development of a new version. It accepts a version string (such as `0.0.6`) as input and runs the following steps:
